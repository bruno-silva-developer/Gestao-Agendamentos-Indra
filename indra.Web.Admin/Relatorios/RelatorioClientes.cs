...
namespace indra.Web.Admin.Relatorios
{
    public class RelatorioClientes
    {
        ...
        public RelatorioClientes(IWebHostEnvironment oHostEnvironment)
        {
        ...
        private void ReportSubHeader()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("QTD de Clientes", fontStyleBold));
            ...
            _pdfPCell = new PdfPCell(new Phrase(_clientes.Count().ToString(), _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            _pdfTableSubHeader.AddCell(_pdfPCell);
            ...
            _pdfPCell = new PdfPCell(new Phrase("Celular", fontStyleBold));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            _pdfTable.AddCell(_pdfPCell);
        ...
        private void ReportHeader()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("Relatório Detalhado de Clientes", _fontStyle));
        ...
        private void ReportBody()
        {
            ...
            foreach (var cliente in _clientes)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(cliente.Id.ToString(), _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(cliente.Nome, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(cliente.Email, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(cliente.Celular, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(cliente.DtCriacao.ToString(), _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
